...
void
glthread_add_next(glthread1_t *base_glthread, glthread1_t *new_glthread);

void
glthread_add_before(glthread1_t *base_glthread, glthread1_t *new_glthread);

void
remove_glthread(glthread1_t *glthread);

void
init_glthread(glthread1_t *glthread);

void
glthread_add_last(glthread1_t *base_glthread, glthread1_t *new_glthread);
...
#define GLTHREAD_TO_STRUCT(fn_name, structure_name, field_name)                        \
    static inline structure_name * fn_name(glthread1_t *glthreadptr){                   \
...
{                                                                                                  \
    glthread1_t *_glthread_ptr = NULL;                                                              \
...
void
delete_glthread_list(glthread1_t *base_glthread);

unsigned int 
get_glthread_list_count(glthread1_t *base_glthread);

void
glthread_priority_insert(glthread1_t *base_glthread,     
...
#if 0
void *
gl_thread_search(glthread1_t *base_glthread,
