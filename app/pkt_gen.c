...
#define INGRESS_INTF_NAME       "eth0/7"      /*Specify Any existing interface of the node S.*/
...
main(int argc, char **argv){
    ...
    strncpy(send_buffer, INGRESS_INTF_NAME, MAX_NAME_SIZE);
  /*Prepare pseudo ethernet hdr*/
    ethernet_hdr_t *eth_hdr = (ethernet_hdr_t *)(send_buffer + MAX_NAME_SIZE);
